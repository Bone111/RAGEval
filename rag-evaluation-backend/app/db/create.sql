...
-- model_info 索引
CREATE INDEX IF NOT EXISTS idx_model_info_user_id ON model_info(user_id);
CREATE INDEX IF NOT EXISTS idx_model_info_model_type ON model_info(model_type);
CREATE INDEX IF NOT EXISTS idx_model_info_status ON model_info(status);
CREATE INDEX IF NOT EXISTS idx_model_info_model_source ON model_info(model_source);
CREATE INDEX IF NOT EXISTS idx_model_info_is_active ON model_info(is_active);
CREATE INDEX IF NOT EXISTS idx_model_info_is_favorite ON model_info(is_favorite);
CREATE INDEX IF NOT EXISTS idx_model_info_created_at ON model_info(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_model_info_last_used_at ON model_info(last_used_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_model_usage_logs_started_at ON model_usage_logs(started_at DESC);

-- model_download_tasks 索引
CREATE INDEX IF NOT EXISTS idx_model_download_tasks_user_id ON model_download_tasks(user_id);
CREATE INDEX IF NOT EXISTS idx_model_download_tasks_status ON model_download_tasks(status);
CREATE INDEX IF NOT EXISTS idx_model_download_tasks_model_source ON model_download_tasks(model_source);
CREATE INDEX IF NOT EXISTS idx_model_download_tasks_created_at ON model_download_tasks(created_at DESC);

-- local_model_registry 索引
CREATE INDEX IF NOT EXISTS idx_local_model_registry_model_name ON local_model_registry(model_name);
CREATE INDEX IF NOT EXISTS idx_local_model_registry_model_type ON local_model_registry(model_type);
CREATE INDEX IF NOT EXISTS idx_local_model_registry_scan_status ON local_model_registry(scan_status);
CREATE INDEX IF NOT EXISTS idx_local_model_registry_last_scanned ON local_model_registry(last_scanned DESC);

-- model_categories 索引
CREATE INDEX IF NOT EXISTS idx_model_categories_name ON model_categories(name);
CREATE INDEX IF NOT EXISTS idx_model_categories_is_active ON model_categories(is_active);
CREATE INDEX IF NOT EXISTS idx_model_categories_sort_order ON model_categories(sort_order);

-- model_category_mappings 索引
CREATE INDEX IF NOT EXISTS idx_model_category_mappings_model_id ON model_category_mappings(model_id);
CREATE INDEX IF NOT EXISTS idx_model_category_mappings_category_id ON model_category_mappings(category_id);
